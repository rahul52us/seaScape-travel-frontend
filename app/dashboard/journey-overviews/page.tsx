...
const JourneyOverviews = observer(() => {
  ...
  const {
    journeyOverviewStore: { getJourneyOverviews },
  } = stores;

  const getData = useCallback(
    ({ page } = { page: currentPage }) => {
      getJourneyOverviews({ page, limit: 15 });
    },
    [currentPage, getJourneyOverviews]
  );
...
export default JourneyOverviews;
